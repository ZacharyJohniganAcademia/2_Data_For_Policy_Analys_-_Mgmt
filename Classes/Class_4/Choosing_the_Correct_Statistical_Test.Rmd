---
title: "Choosing_the_Correct_Statistical_Test"
...
Introduction to Regression with SPSS: Lesson 2 – Regression Diagnostics
 Summary
The article discusses the three types of variables: categorical, ordinal, and interval. Categorical variables have no intrinsic ordering, while ordinal variables have a clear ordering but inconsistent spacing between categories. Interval variables have equally spaced intervals and can be used for statistical computations. The article also emphasizes the importance of understanding the level of measurement of variables when performing statistical analyses.