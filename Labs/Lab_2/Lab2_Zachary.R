...
package.list <- c("tidyverse", "ggplot2") # addition of a new package for this class
...
# Creating a CSV file out of the nsece_2019_wf_recode
write_csv(nsece_2019_wf_recode, "nsece_2019_wf_subset.csv")
