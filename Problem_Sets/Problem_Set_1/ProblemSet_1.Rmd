...
output: pdf_document
---
test to see if i can work from my phone on r workbench now.
...
Rename the variables using clear, descriptive names. Perform any data cleaning you
consider necessary. For each variable, identify its level of measurement (nominal,
ordinal, or interval/ratio) and whether it is discrete or continuous. Include the
appropriate descriptive statistics, tables, or graphs, as well as measures of central
tendency, dispersion, and shape when applicable. Describe and interpret your findings.
(4 points)
```{r}
```
